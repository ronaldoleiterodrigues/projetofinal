<section class='canva shadow-down mg-t-2 bg-branco radius pd-20'>
    <div class="box-12 flex justify-center limpar">
        <div class="box-8">
            <h1 class="fonte32 fonte-roboto fw-300 mg-b-2"><i class="fa-solid fa-user-pen fonte28 fnc-cinza mg-r-1"></i>Tecnicos</h1>
        </div>
        <div class="box-4 new-add">
            <div class="w-100 flex justify-end">
                ...
                <div class="w-70 bg-p2-azul pd-10 radius-end"><a href="index.php?controller=TecnicoController&metodo=Index" class="fnc-branco ">Novo Cadastro</a></div>
            </div>
        </div>
    </div>
    ...
    <table id="table" class="">
        ...
        <thead class="head">
            <tr>
                ...
                <th class="pd-10 fonte16 fw-400 espaco-letra fnc-preto fonte-poppin txt-e">Data Nascimento</th>
                <th class="pd-10 fonte16 fw-400 espaco-letra fnc-preto fonte-poppin txt-e">Cor</th>
                <th class="pd-10 fonte16 fw-400 espaco-letra fnc-preto fonte-poppin txt-e">Sexo</th>
                <th class="pd-10 fonte16 fw-400 espaco-letra fnc-preto fonte-poppin txt-e">Tipo Profissão</th>
                <th class="pd-10 fonte16 fw-400 espaco-letra fnc-preto fonte-poppin txt-e">Data Inclusão</th>
                <th class="pd-10 fonte16 fw-400 espaco-letra fnc-preto fonte-poppin txt-e">Data Exclusão</th>
                    ...
                    foreach ($ret as $dados) { ?>
                        <tr class="zebra">
                            ...
                            <td class="pd-l-1 fonte12 espaco-letra txt-e flex justify-center item-centro">
                                ...
                                <a href="index.php?controller=TecnicoController&metodo=Index&id=<?php echo $dados->ID ?>"> <i class="fa-regular fa-pen-to-square fonte14 fnc-laranja"></i> </a>
                            </td>
                        </tr>
                <?php     }
                }
