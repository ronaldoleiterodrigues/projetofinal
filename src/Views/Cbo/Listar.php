                    ...
                    foreach ($ret as $dados) { ?>
                        <tr class="zebra">
                            ...
                            <td class="pd-l-1 fonte12 espaco-letra txt-e flex justify-center item-centro">
                                <a href="index.php?controller=CboController&metodo=DeleteConfirm&id=<?php echo $dados->ID ?>"> <i class="fa-solid fa-trash-can fonte14 fnc-tomato mg-r-2"></i> </a>
                                <a href="index.php?controller=CboController&metodo=Index&id=<?php echo $dados->ID ?>"> <i class="fa-regular fa-pen-to-square fonte14 fnc-laranja"></i> </a>
                            </td>
                        </tr>
                <?php     }
                }
